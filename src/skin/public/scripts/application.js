...
/******/ 	__webpack_require__.p = "/src/skin/public/";
/******/
...
// CONCATENATED MODULE: ./src/skin/assets/scripts/ajax-helper.js
...
/* harmony default export */ var ajax_helper = (ajax);
// CONCATENATED MODULE: ./src/skin/assets/scripts/scriptsAdmin.js



jquery_default()(function () {

  const $notificationElement = jquery_default()('.js-processed-posts');
  const allPosts = $notificationElement.data('posts');

  jquery_default()('.js-start-post-resave').on('click', function () {
    let finished = false;
    for (const ID in allPosts) {
      if (allPosts.hasOwnProperty(ID)) {
        ...
        ajax_helper.ajaxResavePost(allPosts[ID], finished, $notificationElement);
      }
    }
  });
});
// CONCATENATED MODULE: ./src/skin/assets/application.js
// Load Scripts
